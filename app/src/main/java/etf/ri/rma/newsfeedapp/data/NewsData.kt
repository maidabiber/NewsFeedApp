...
object NewsData {
    fun getAllNews(): List<NewsItem> {
        return listOf(
            ...
            NewsItem("2", "Objavljena kompletna presuda protiv Dodika: Pojašnjeno zašto su brojne primjedbe odbrana bile neutemeljene", "Sud BiH je objavio kompletnu prvostepenu presudu predsjedniku RS Miloradu Dodiku i v.d. direktora 'Službenog glasnika RS' Milošu Lukiću. Riječ je o dokumentu od 150…", null, "Politika",  false,  "Dnevni avaz", "27.3.2025." ),
            NewsItem("4", "Pobjeda Zmajeva u Bukureštu", "U prvom kolu grupe H kvalifikacija za Svjetsko prvenstvo 2026, reprezentacija Bosne i Hercegovine savladala je Rumuniju rezultatom 1:0 u utakmici koja je odigrana na Nacionalnoj areni u Bukureštu.", null, "Sport", false, "Fudbalski savez BiH", "21.3.2025."),
            NewsItem("5", "Košarkaši BiH plasirali se na Eurobasket 2025!", "U pretposljednjem kolu kvalifikacija za Eurobasket 2025, košarkaši Bosne i Hercegovine pobijedili su Kipar rezultatom 108:62. Ovom pobjedom, uz poraz Hrvatske od Francuske, osigurali su plasman na Evropsko prvenstvo.", null, "Sport", true, "Tuzlanski.ba", "21.2.2025."),
            NewsItem("6", "BH učenici briljirali na iFest2 takmičenju nauke, tehnologije i inovacija",  "Bosanskohercegovački učenici ostvarili su značajan uspjeh na iFest2 takmičenju iz oblasti nauke, tehnologije i inovacija.", null, category = "Nauka / tehnologija",  true, "vijesti.ba",  "29.3.2025."),

            NewsItem("3","Vukanović prozvao Čovića - smatra ga licemjerom...","Pozvao ga da se javno izjasni o ponašanju Milorada Dodika, kazavši da je nemoguće zalagati se za evropske integracije, a podržavati ovakve poteze..." ,null, "Politika", false, "oslobodjenje.ba", "30.3.2025."),

               NewsItem("7", "Na Univerzitetu u Sarajevu \"Dani otvorenih vrata\" 4. i 5. aprila", "Univerzitet u Sarajevu najavljuje \"Dane otvorenih vrata\", koji će biti održani 4. i 5. aprila na fakultetima i akademijama Univerziteta.", null, "Nauka / tehnologija", false, "VijestiBa", "3.4.2025." ),
            NewsItem("8", "AI budućnost u BiH: ETF Sarajevo pokreće inovativni studijski program uz podršku dijaspore", "Elektrotehnički fakultet Univerziteta u Sarajevu pokreće novi studijski program fokusiran na umjetnu inteligenciju, uz značajnu podršku bosanskohercegovačke dijaspore.", null, "Nauka / tehnologija", true, "Klix.ba", "4.4.2025."),
            NewsItem("9", "Ramo Isak o hapšenju Dodika: 'Policajci koji se boje pucanja neka idu raditi u obdanište'", "Ministar unutrašnjih poslova Federacije Bosne i Hercegovine Ramo Isak gostovao je u emisiji Istraga sedmice na Hayat televiziji. Isak je govorio o hapšenju predsjednika bosanskohercegovačkog entiteta RS Milorada Dodika.", null, "Politika", false, "Radiosarajevo.ba", "7.4.2025."),
            ...
            NewsItem("11", "Ostaje pitanje kakva bi karijera Nurkića bila bez povreda", "Bh. košarkaš Jusuf Nurkić, član Charlotte Hornetsa, uskoro bi se mogao vratiti na teren nakon ponovnog odsustva zbog povrede.", null, "Sport", false, "Sport.ba", "10.3.2025."
            ),
            ...
            NewsItem("13", "Anel Ahmedhodžić napustio reprezentaciju BiH: ‘Nemam više...’", "Ahmedhodžić je odlučio da javno odgovori na sve prozivke i otkrije detalje o svojoj odluci da se povuče iz reprezentacije Bosne i Hercegovine. Ahmedhodžić je napustio kamp...", null, "Sport", false, "Radiosarajevo.ba", "11.9.2024."),
            NewsItem("14", "Izetbegović: Siguran sam da će Dodik biti uhapšen, ne smijemo upasti u njegovu zamku", "Predsjednik Stranke demokratske akcije Bakir Izetbegović siguran je da će predsjednik Republike Srpske Milorad Dodik biti uhapšen, no nije siguran da će to biti brzo i lako.", null, "Politika", false, "Fena", "7.4.2025."
            ),
            ...
            NewsItem("19", "Velež i Sarajevo igraju derbi, meč iz Mostara u direktnom TV prenosu", "Fudbalske ekipe Veleža i Sarajeva igraju derbi susret koji će biti prenošen uživo na televiziji iz Mostara.", null, "Sport", true, "Radiosarajevo.ba", "8.3.2025."
            ),
