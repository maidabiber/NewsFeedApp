...
@Composable
fun FeaturedNewsCard(nasaTrenutnaVijest: NewsItem, onClick: () -> Unit, jeLiKlikIzvrsen: Boolean
) {
    ...
    Card( Modifier.fillMaxWidth().padding(8.dp).clickable(onClick = onClick),
        ...
        Column(Modifier.padding(9.dp)) {
            ...
            Image(painter = painterResource(R.drawable.bosnjaci),
